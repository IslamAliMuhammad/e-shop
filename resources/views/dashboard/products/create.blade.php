        ...
        <form action="{{ route('dashboard.products.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea name="en[description]" class="form-control" id="enDescriptionInp" placeholder="{{ __('Enter Description In English') }}" required>{{ old('en.description') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <textarea name="ar[description]" class="form-control" id="arDescriptionInp" placeholder="{{ __('Enter Description In Arabic') }}" required>{{ old('ar.description') }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" step="0.01" name="price" class="form-control" id="priceInp" placeholder="{{ __('Enter Price') }}" value="{{ old('price') }}" required>
                    @error("price")
                        @include('dashboard.partials._validation-alert')
                    @enderror
                </div>
