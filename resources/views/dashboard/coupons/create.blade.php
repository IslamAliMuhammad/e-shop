        ...
        <form action="{{ route('dashboard.coupons.store') }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="code" class="form-control" id="codeInp" placeholder="{{ __('Enter Code') }}" value="{{ old('code') }}" required>
                    @error("code")
                ...
                <div class="mt-3 form-group">
                    ...
                    <input type="number" min="0" name="discount_amount" class="form-control" id="discountAmountInp" placeholder="{{ __('Enter Discount Amount') }}" value="{{ old('discount_amount') }}" required>
                ...
                <div class="mt-3 form-group">
                    ...
                    <input type="number" min="0" name="min_amount" class="form-control" id="minAmountInp" placeholder="{{ __('Enter Minimum Amount') }}" value="{{ old('min_amount') }}" required>
                    @error("min_amount")
                        @include('dashboard.partials._validation-alert')
                    @enderror
                </div>
